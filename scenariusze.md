...
| **Warunki wstępne**  |   Wykładowca jest zalogowany oraz posiada podstęp do zarządzania kursem  |
...
| **Opis**             |   Wykładowca wybiera z menu kursu opcję „Zarzadzanie pliki kursu”. System sprawdza uprawnienia wykładowcy oraz dostępność kursu. Po pozytywnej weryfikacji system ładuje interfejs zarządzania plikami, w którym dostępne są opcje dodawania, edycji oraz usuwania plików związanych z kursem.  |
...
| **Warunki wstępne**  |  Wykladowca ma dostęp do funkcji tworzenia skrzynki   |
| **Niezmienniki**     |  Wykladowca wysyla zapytanie o utworzenie skrzynki   |
| **Opis**             |  Wykladowca wybiera opcję „Stwórz skrzynkę”. Wprowadza nazwe i opis skrzynki. System weryfikuje poprawność danych. Po pozytywnej weryfikacji skrzynka zostaje utworzona, a wykladowca otrzymuje komunikat o powodzeniu operacji.   |
TODO| **Warunki końcowe**  |  Skrzynka zostaje utworzona, *Wykladowca otrzymuje potwierdzenie, do dyskusji z kacprem*   |
| **Źródło ewentualnych problemów** |  Błędne lub niepełne dane w formularzu – system wyświetla komunikat o błędzie i prosi o ponowne wprowadzenie danych |
...
| **Opis**             |   Wykładowca wybiera „Dodaj plik”, wybiera plik z lokalnego dysku i zatwierdza. System sprawdza format, rozmiar i uprawnienia. Po pomyślnej weryfikacji plik zostaje zapisany i dodany do kursu.  |
...
| **Opis**             |   Wykładowca znajduje na liście plików żądany plik i wybiera opcję „Usuń plik”. System prosi o potwierdzenie operacji, a po potwierdzeniu usuwa plik z bazy danych i serwera.  |
